...
public class RemoteVirtualMachineImpl implements VirtualMachine {

	public static final Logger log = org.apache.log4j.Logger.getLogger(RemoteVirtualMachineImpl.class);
	
	private JVM jvm;
	private JPFInspectorClientInterface inspector;

	public RemoteVirtualMachineImpl(JPFInspectorClientInterface inspector, JPF jpf) {
