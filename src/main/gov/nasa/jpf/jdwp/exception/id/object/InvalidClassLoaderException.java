 ...
 * 
 */
public class InvalidClassLoaderException extends InvalidObjectException {

  /**
   * 
   */
  private static final long serialVersionUID = -7798829200624997467L;
   ...
   */
  public InvalidClassLoaderException(ObjectId objectId) {
    super(ErrorType.INVALID_CLASS_LOADER, objectId);
  }
